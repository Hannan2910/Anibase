...
<link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
  ...
  <?php $conn=mysqli_connect("localhost:3306","root","","anibase") or die("Connection Failed!!!");
        $res=$conn->query("select anime.A_id,A_name,A_score,poster from anime,producer_of_anime where producer_of_anime.A_id=anime.A_id and P_id=$pid and work='Studio' order by A_score desc");
   ?>
  <body>
<div class="container">
  <div class="nav-bar">
