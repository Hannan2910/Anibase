...
<link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
  ...
  <?php $conn=mysqli_connect("localhost:3306","root","","anibase") or die("Connection Failed!!!");
        $res=$conn->query("select dropped_anime.A_id,A_name,dropped_anime.score,poster from anime,dropped_anime where anime.A_id=dropped_anime.A_id and dropped_anime.Name='$name' order by dropped_anime.score desc");
   ?>
  <body>
<div class="container">
  <div class="nav-bar">
...
while( $row=$res->fetch_assoc()):
  ...
  <tr>
    ...
    <td> <div class="animg">
      ...
      <form class='list-button' action='deldr.php' method='post'>
