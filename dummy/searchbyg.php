...
<div class="container">
  ...
  <div class="searcher">
    <form class="" action="searchbyg.php" method="post">
...
<?php $ga="";
if(isset($_POST['gname'])){$ga=$_POST['gname'];}?>
<?php $res=$conn->query("select anime.A_id,A_name,A_score,poster from anime,genre_of_anime,genre where genre_of_anime.A_id=anime.A_id and genre_of_anime.G_id=genre.G_id and genre.G_name='$ga' order by A_score desc"); ?>
<div class="table">
