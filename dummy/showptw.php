...
<html>
  <head>
    <meta charset="utf-8">
    <title>Plan to Watch Anime</title>
...
<link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
  ...
  <?php $conn=mysqli_connect("localhost:3306","root","","anibase") or die("Connection Failed!!!");
        $res=$conn->query("select plan_to_watch.A_id,A_name,A_score,poster from anime,plan_to_watch where anime.A_id=plan_to_watch.A_id and plan_to_watch.Name='$name' order by A_score desc");
   ?>
  <body>
<div class="container">
  <div class="nav-bar">
...
while( $row=$res->fetch_assoc()):
  ...
  <tr>
    ...
    <td> <div class="animg">
      ...
      <form class='list-button' action='delptw.php' method='post'>
