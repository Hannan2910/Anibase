...
<link href="https://fonts.googleapis.com/css2?family=Montserrat&display=swap" rel="stylesheet">
  ...
  <?php $conn=mysqli_connect("localhost:3306","root","","anibase") or die("Connection Failed!!!");
        $res=$conn->query("select watched_anime.A_id,A_name,watched_anime.score,poster from anime,watched_anime where anime.A_id=watched_anime.A_id and watched_anime.Name='$name' order by watched_anime.score desc");
   ?>
  <body>
<div class="container">
  <div class="nav-bar">
...
while( $row=$res->fetch_assoc()):
  ...
  <tr>
    ...
    <td> <div class="animg">
      ...
      <form class='list-button' action='delwa.php' method='post'>
